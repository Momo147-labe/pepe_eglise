            ...
            data: <List<String>>[
              ...
              ...members.map(
                (m) => [
                  ...
                  _clean(m.fullName),
                  _clean(m.gender),
                  (m.birthDate != null && m.birthDate!.length >= 10) ? m.birthDate!.substring(0, 10) : "",
                  (m.joinedAt.length >= 10) ? m.joinedAt.substring(0, 10) : m.joinedAt,
                  _clean(m.groupName),
              ...
              pw.Expanded(
                child: pw.Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow(
                      "DATE DE NAISSANCE",
                      (member.birthDate != null && member.birthDate!.length >= 10) ? member.birthDate!.substring(0, 10) : "",
                    ),
                    _buildInfoRow(
                      "DATE D'ADHÉSION",
                      (member.joinedAt.length >= 10) ? member.joinedAt.substring(0, 10) : member.joinedAt,
                    ),
